...
class MonascaPublisher(publisher.ConfigPublisherBase):
    ...
    def __init__(self, conf, parsed_url):
        ...
        self.conf.register_opts(monpub_opts, group='monasca')
    ...
    @periodics.periodic(spacing=cfg.CONF.monasca.batch_polling_interval)
    ...
    @periodics.periodic(spacing=cfg.CONF.monasca.retry_interval)
