...
class GPUMemTotalPollster(pollsters.BaseComputePollster):

    def get_samples(self, manager, cache, resources):
        for instance in resources:
            LOG.debug('checking instance %s', instance.id)
            try:
                if not self.inspector.inspect_cloudcommune_version(instance):
...
class GPUMemUsedPollster(pollsters.BaseComputePollster):
...
class GPUUtilPollster(pollsters.BaseComputePollster):
...
class GPUTempPollster(pollsters.BaseComputePollster):
